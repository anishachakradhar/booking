        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.availableDate.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.available-dates.update", [$availableDate->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('available_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="available_date" id="available_date" value="{{ old('available_date', $availableDate->available_date) }}">
